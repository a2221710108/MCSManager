...
const COMMAND_GROUPS: CommandGroup[] = [
  ...
  },
  {
    ...
    commands: [
      ...
      { label: t("殭屍增援隊"), cmd: "attribute {player} minecraft:spawn_reinforcements base set {text}", placeholder: t("數值") }, 
  ...
  },
  {
    ...
    commands: [
      ...
      { label: t("殭屍增援隊"), cmd: "attribute @a minecraft:spawn_reinforcements base set {text}", placeholder: t("數值") }, 
